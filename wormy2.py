    ...
    while True: # main game loop
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT:
                ...
                if (event.key == K_LEFT or event.key == K_a) and direction != RIGHT:  #remember this check for direction
                    direction = LEFT
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('prakhar!', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('prakhar!', True, GREEN)
...
def getRandomLocation():# returning in the form of dictonary 
